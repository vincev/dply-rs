...
fn rename() -> Result<()> {
    ...
    assert_eq!(
        ...
        indoc!(
            ...
            Columns: 19
            +-----------------------+--------------+-----------------------------------------+
            | vendor_id             | i64          | 2, 2, 2, 2, 1, 2, 2, 2, 2, 2, 2, 1, ... |
            | pickup_datetime       | datetime[ns] | 2022-11-22 19:27:01, 2022-11-27...      |
            | dropoff_datetime      | datetime[ns] | 2022-11-22 19:45:53, 2022-11-27...      |
            ...
            | pu_location_id        | i64          | 234, 48, 142, 79, 237, 137, 107, 229... |
            | do_location_id        | i64          | 141, 142, 236, 75, 230, 140, 162, 16... |
